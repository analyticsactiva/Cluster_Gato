...
x_dummies_cols = ['SEXO_Hombre', 'SEXO_Mujer', 'GSE_POND_ESOMAR_ABC1',
       ...
       'P6_D_Una vez cada 2 o 3 meses', 'P6_E_2',
       'P6_E_A diario/ Varias veces a la semana',
       'P6_E_Nunca/ Casi nunca', 'P6_E_Pocas veces al año',
       'P6_E_Una o dos veces a la semana', 'P6_E_Una o dos veces al mes',
       'P6_E_Una vez cada 2 o 3 meses', 'P6_F_2',
       ...
       'P6_L_Pocas veces al año', 'P6_L_Una o dos veces a la semana',
       'P6_L_Una o dos veces al mes', 'P6_L_Una vez cada 2 o 3 meses',
       'P6_M_2', 'P6_M_A diario/ Varias veces a la semana',
       'P6_M_Nunca/ Casi nunca', 'P6_M_Pocas veces al año',
       'P6_M_Una o dos veces a la semana', 'P6_M_Una o dos veces al mes',
       'P6_M_Una vez cada 2 o 3 meses', 'P6_N_2',
...
with open('scaler_cat.pkl','rb') as f:
    scaler = pickle.load(f)

# load the model from disk
filename = 'finalized_model_cat.sav'
